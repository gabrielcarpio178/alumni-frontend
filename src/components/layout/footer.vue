<template>
    <footer class="mt-5 bg-white dark:bg-gray-800 border-gray-200 text-white w-screen">
            ...
            <div class="flex md:flex-row flex-col items-center justify-center gap-10">
                <div class="flex flex-row items-center gap-x-3">
                    ...
                    <h2 class="text-2xl font-bold">
                        {{this.system_data.contact_number}}
                    </h2>
                </div>
                <div class="flex flex-row items-center gap-x-3">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="5rem" height="5rem" viewBox="0 0 24 24">
                                <path fill="white" d="M22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2zm-2 0l-8 5l-8-5zm0 12H4V8l8 5l8-5z" />
                            </svg>
                    </div>
                    <h2 class="text-2xl font-bold">
                        <a :href="'mailto:'+this.system_data.email">{{this.system_data.email}}</a>
                    </h2>
                </div>
            </div>
        </div>
