        ...
        <div class="m-10 max-w-sm w-3/4 md:w-1/2 relative">
            ...
            <div class="rounded-lg border bg-white dark:bg-gray-800 dark:border-gray-700 px-4 shadow-lg flex flex-col items-start text-white">
                ...
                <div class="flex flex-col gap-y-1">
                    ...
                    <div class="flex flex-row gap-x-2 w-full mt-2" v-if='job.isViewJob'>
                        <button type="button" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" @click="showForm">Edit</button>
